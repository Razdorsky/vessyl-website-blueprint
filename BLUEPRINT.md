...
- **Glass navigation:** navigation, language and the combined Booking/App group share a 48px height, capsule corners, one-pixel outline and common glass surface. Booking and App are two links inside one navigation-like capsule, with no individual frames or filled segments. The Experience panel spans the full viewport width with 24px rounded corners, large photo cards and an independent Overview link. A globe popover and inset mobile sheet retain their own content layouts. Desktop navigation switches at 1320px to accommodate both locales. Desktop visual and keyboard order is navigation, language, then the combined Book a Stay / Download App group; booking remains first inside the group. The adapted Arkkhe material uses Vessyl paper/forest, a restrained highlight, blur and a solid fallback. Photo/menu cards underline only their labels; Overview stays a separate link. Keyboard traversal follows the visual hierarchy.
